////
////  MozambiquePassportParser.swift
////  Sybrin.iOS.Identity
////
...
//////import MLKit
//
//struct MozambiquePassportParser {
//    
//    // MARK: Private Properties
//    // Parser
//    private let Parser = TraditionalTD3Parser(issuingCountryCode: Country.Mozambique.passportCountryCode)
//    
//    // Resetting Model
...
//    mutating func Parse(from result: Text, success: @escaping (_ model: MozambiquePassportModel) -> Void) {
...
//        }
//    
//        if Parser.Line1Parsed && Parser.Line2Parsed, let model = TD3ModelToMozambiquePassportModel(Parser.Model) {
//            success(model)
//            Reset()
//        }
//        
...
//    }
//    
//    private func TD3ModelToMozambiquePassportModel(_ td3Model: TD3Model) -> MozambiquePassportModel? {
//        let model = MozambiquePassportModel()
//        
...
//        model.IdentityNumber = td3Model.OptionalData
//        model.IdentityNumberCheckDigit = td3Model.OptionalDataCheckDigit
