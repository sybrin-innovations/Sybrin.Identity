//
//  MozambiqueIDCardScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class MozambiqueIDCardScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            MozambiqueIDCardFrontScanPhase(name: "Mozambique ID Card Front"),
            MozambiqueIDCardBackScanPhase(name: "Mozambique ID Card Back")
        ])
    }
