...
@objc public final class MozambiqueIDCardModel: IDCardModel {
    
    // MARK: Private Properties
    private enum CodingKeys: String, CodingKey { case mrzLine1, mrzLine2, mrzLine3, issuingCountryCode, identityNumberCheckDigit, optionalData1, dateOfBirthCheckDigit, dateOfExpiry, dateOfExpiryCheckDigit, optionalData2, compositeCheckDigit, surname, names }
