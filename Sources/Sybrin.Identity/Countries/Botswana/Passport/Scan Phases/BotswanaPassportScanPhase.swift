////
////  BotswanaPassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
//////import MLKit
//
//final class BotswanaPassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = BotswanaPassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? BotswanaPassportModel else { return }
