...
//////import MLKit
//
//struct BotswanaPassportParser {
//    
//    // MARK: Private Properties
//    // Parser
//    private let Parser = TraditionalTD3Parser(issuingCountryCode: Country.Botswana.passportCountryCode)
//    
//    // Resetting Model
...
//    mutating func Parse(from result: Text, success: @escaping (_ model: BotswanaPassportModel) -> Void) {
...
//        }
//    
//        if Parser.Line1Parsed && Parser.Line2Parsed, let model = TD3ModelToBotswanaPassportModel(Parser.Model) {
//            success(model)
//            Reset()
//        }
//        
...
//    }
//    
//    private func TD3ModelToBotswanaPassportModel(_ td3Model: TD3Model) -> BotswanaPassportModel? {
//        let model = BotswanaPassportModel()
//        
