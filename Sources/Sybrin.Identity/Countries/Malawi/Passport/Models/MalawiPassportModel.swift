...
@objc public final class MalawiPassportModel: PassportModel {
    
    // MARK: Private Properties
    private enum CodingKeys: String, CodingKey { case mrzLine1, mrzLine2, passportNumberCheckDigit, dateOfBirthCheckDigit, dateOfExpiryCheckDigit, personalNumber, personalNumberCheckDigit, compositeCheckDigit }
    ...
    final var PersonalNumber: String?
    final var PersonalNumberCheckDigit: Int?
    ...
    @objc public final var personalNumber: String? { get { return self.PersonalNumber } }
    @objc public final var personalNumberCheckDigit: Int { get { return self.PersonalNumberCheckDigit ?? -1 } }
    ...
    public final override func encode(to encoder: Encoder) throws {
        ...
        try container.encode(personalNumberCheckDigit, forKey: .personalNumberCheckDigit)
