...
//////import MLKit
//
//struct EgyptPassportParser {
//    
//    // MARK: Private Properties
//    // Parser
//    private let Parser = TraditionalTD3Parser(issuingCountryCode: Country.Egypt.passportCountryCode)
//    
//    // Resetting Model
...
//    mutating func Parse(from result: Text, success: @escaping (_ model: EgyptPassportModel) -> Void) {
...
//        }
//    
//        if Parser.Line1Parsed && Parser.Line2Parsed, let model = TD3ModelToEgyptPassportModel(Parser.Model) {
//            success(model)
//            Reset()
//        }
//        
...
//    }
//    
//    private func TD3ModelToEgyptPassportModel(_ td3Model: TD3Model) -> EgyptPassportModel? {
//        let model = EgyptPassportModel()
//        
