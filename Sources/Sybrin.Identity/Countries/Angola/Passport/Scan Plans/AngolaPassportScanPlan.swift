...
//import UIKit
//
//final class AngolaPassportScanPlan: ScanPlan<DocumentModel> {
//    
//    // MARK: Overrided Properties
//    final override var Phases: ScanPhaseList<DocumentModel> {
//        return ScanPhaseLiast(phases: [
//            AngolaPassportScanPhase(name: "Angola Passport")
//        ])
//    }
//    
