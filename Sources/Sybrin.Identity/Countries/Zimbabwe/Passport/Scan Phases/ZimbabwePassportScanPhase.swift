////
////  ZimbabwePassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
////import MLKit
//
//final class ZimbabwePassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = ZimbabwePassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? ZimbabwePassportModel else { return }
