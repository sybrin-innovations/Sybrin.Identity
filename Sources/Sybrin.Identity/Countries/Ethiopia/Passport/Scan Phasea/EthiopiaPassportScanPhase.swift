////
////  EthiopiaPassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
//////import MLKit
//
//final class EthiopiaPassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = EthiopiaPassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? EthiopiaPassportModel else { return }
