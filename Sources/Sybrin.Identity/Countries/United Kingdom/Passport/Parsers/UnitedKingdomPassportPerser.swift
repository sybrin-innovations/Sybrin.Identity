////
////  UnitedKingdomPassportPerser.swift
////  Sybrin.iOS.Identity
////
////  Created by Armand Riley on 2021/08/20.
////  Copyright © 2021 Sybrin Systems. All rights reserved.
////
////import MLKit
//
//struct UnitedKingdomPassportParser {
//    
//    // MARK: Private Properties
//    // Parser
//    private let Parser = TraditionalTD3Parser(issuingCountryCode: Country.UnitedKingdom.passportCountryCode)
//    
//    // Resetting Model
...
//    mutating func Parse(from result: Text, success: @escaping (_ model: UnitedKingdomPassportModel) -> Void) {
...
//        }
//    
//        if Parser.Line1Parsed && Parser.Line2Parsed, let model = TD3ModelToUnitedKingdomPassportModel(Parser.Model) {
//            success(model)
//            Reset()
//        }
//        
...
//    }
//    
//    private func TD3ModelToUnitedKingdomPassportModel(_ td3Model: TD3Model) -> UnitedKingdomPassportModel? {
//        let model = UnitedKingdomPassportModel()
//        
