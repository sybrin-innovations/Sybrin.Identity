////
////  UnitedKingdomPassportScanPlan.swift
////  Sybrin.iOS.Identity
////
...
//import UIKit
//
//final class UnitedKingdomPassportScanPlan: ScanPlan<DocumentModel> {
//    
//    // MARK: Overrided Properties
//    final override var Phases: ScanPhaseList<DocumentModel> {
//        return ScanPhaseList(phases: [
//            UnitedKingdomPassportScanPhase(name: "United Kingdom Passport")
//        ])
//    }
//    
