//
//  SouthAfricaStudyPermitScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class SouthAfricaStudyPermitScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            SouthAfricaStudyPermitScanPhase(name: "South Africa Study Permit")
        ])
    }
