//
//  SouthAfricaStudyPermitModel.swift
//  Sybrin.iOS.Identity
//
...
@objc public final class SouthAfricaStudyPermitModel: DocumentModel {
    
    // MARK: Private Properties
    private enum CodingKeys: String, CodingKey { case names, passportNumber, numberOfEntries, validFrom, dateOfExpiry, issuedAt, controlNumber, barcodeData }
    
    // MARK: Overrided Offsets
    final override var CroppingLeftOffset: CGFloat { return 1.1 }
    final override var CroppingTopOffset: CGFloat { return 11 }
    final override var CroppingWidthOffset: CGFloat { return 2.2 }
    final override var CroppingHeightOffset: CGFloat { return 15 }
