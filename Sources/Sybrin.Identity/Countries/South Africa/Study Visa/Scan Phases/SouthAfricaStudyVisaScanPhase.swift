////
////  SouthAfricaStudyVisaScanPhase.swift
////  Sybrin.iOS.Identity
////
...
////import MLKit
//
//final class SouthAfricaStudyVisaScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Barcode: Barcode?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = SouthAfricaStudyVisaParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? SouthAfricaStudyVisaModel else { return }
