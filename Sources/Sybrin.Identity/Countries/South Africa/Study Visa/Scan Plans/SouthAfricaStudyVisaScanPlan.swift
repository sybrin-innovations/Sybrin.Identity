//
//  SouthAfricaStudyVisaScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class SouthAfricaStudyVisaScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            SouthAfricaStudyVisaScanPhase(name: "South Africa Study Visa")
        ])
    }
