//
//  SouthAfricaGeneralWorkVisaModel.swift
//  Sybrin.iOS.Identity
//
...
@objc public final class SouthAfricaGeneralWorkVisaModel: DocumentModel {
    
    // MARK: Private Properties
    private enum CodingKeys: String, CodingKey { case names, passportNumber, numberOfEntries, on, referenceNumber, dateOfExpiry, issuedAt, controlNumber, barcodeData }
    
    // MARK: Overrided Offsets
    final override var CroppingLeftOffset: CGFloat { return 5.1 }
    final override var CroppingTopOffset: CGFloat { return 6 }
    final override var CroppingWidthOffset: CGFloat { return 5 }
    final override var CroppingHeightOffset: CGFloat { return 8 }
    ...
    @objc public final var on: Date? { get { return self.On} }
