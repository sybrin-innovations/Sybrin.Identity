////
////  SouthAfricaGeneralWorkVisaScanPhase.swift
////  Sybrin.iOS.Identity
////
...
////import MLKit
//
//final class SouthAfricaGeneralWorkVisaScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Barcode: Barcode?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = SouthAfricaGeneralWorkVisaParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? SouthAfricaGeneralWorkVisaModel else { return }
