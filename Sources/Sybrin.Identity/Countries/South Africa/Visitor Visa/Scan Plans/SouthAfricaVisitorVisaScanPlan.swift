//
//  SouthAfricaVisitorVisaScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class SouthAfricaVisitorVisaScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            SouthAfricaVisitorVisaScanPhase(name: "South Africa Visitor Visa")
        ])
    }
