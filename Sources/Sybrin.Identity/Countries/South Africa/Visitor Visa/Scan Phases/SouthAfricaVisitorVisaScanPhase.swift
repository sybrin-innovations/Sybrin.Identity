////
////  SouthAfricaVisitorVisaScanPhase.swift
////  Sybrin.iOS.Identity
////
...
////import MLKit
//
//final class SouthAfricaVisitorVisaScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Barcode: Barcode?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = SouthAfricaVisitorVisaParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? SouthAfricaVisitorVisaModel else { return }
