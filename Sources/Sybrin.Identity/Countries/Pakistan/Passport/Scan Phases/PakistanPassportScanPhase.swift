////
////  PakistanPassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
//////import MLKit
//
//final class PakistanPassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = PakistanPassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? PakistanPassportModel else { return }
