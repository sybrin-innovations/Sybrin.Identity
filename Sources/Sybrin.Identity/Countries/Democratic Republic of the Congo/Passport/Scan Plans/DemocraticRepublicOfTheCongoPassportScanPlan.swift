////
////  DemocraticRepublicOfTheCongoPassportScanPlan.swift
////  Sybrin.iOS.Identity
////
...
//import UIKit
//
//final class DemocraticRepublicOfTheCongoPassportScanPlan: ScanPlan<DocumentModel> {
//    
//    // MARK: Overrided Properties
//    final override var Phases: ScanPhaseList<DocumentModel> {
//        return ScanPhaseList(phases: [
//            DemocraticRepublicOfTheCongoPassportScanPhase(name: "Democratic Republic of the Congo Passport")
//        ])
//    }
//    
