////
////  DemocraticRepublicOfTheCongoPassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
//////import MLKit
//
//final class DemocraticRepublicOfTheCongoPassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = DemocraticRepublicOfTheCongoPassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? DemocraticRepublicOfTheCongoPassportModel else { return }
