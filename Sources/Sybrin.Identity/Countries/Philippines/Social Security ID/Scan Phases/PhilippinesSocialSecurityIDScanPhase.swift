//
//  PhilippinesSocialSecurityIDScanPhase.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesSocialSecurityIDScanPhase: ScanPhase<DocumentModel> {
    ...
    final override var MinimumFrameCount: Int { return 60 }
