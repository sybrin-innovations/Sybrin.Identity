//
//  PhilippinesSocialSecurityIDScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesSocialSecurityIDScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesSocialSecurityIDScanPhase(name: "Philippines Social Security ID"),
            PhilippinesSocialSecurityIDNetworkPhase(name: "Confirm")
        ])
    }
