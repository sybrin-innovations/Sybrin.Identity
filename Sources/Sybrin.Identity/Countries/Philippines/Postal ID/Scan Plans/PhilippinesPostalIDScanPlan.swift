//
//  PhilippinesPostalIDScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesPostalIDScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesPostalIDScanPhase(name: "Philippines Postal ID"),
            PhilippinesPostalIDNetworkPhase(name: "Confirm")
        ])
    }
