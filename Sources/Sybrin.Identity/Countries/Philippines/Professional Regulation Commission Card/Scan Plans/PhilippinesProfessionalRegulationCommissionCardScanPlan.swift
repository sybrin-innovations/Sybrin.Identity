//
//  PhilippinesProfessionalRegulationCommissionCardScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesProfessionalRegulationCommissionCardScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesProfessionalRegulationCommissionCardScanPhase(name: "Philippines Professional Regulation Commission Card")
        ])
    }
