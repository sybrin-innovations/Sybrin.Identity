//
//  PhilippinesProfessionalRegulationCommissionCardScanPhase.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesProfessionalRegulationCommissionCardScanPhase: ScanPhase<DocumentModel> {
