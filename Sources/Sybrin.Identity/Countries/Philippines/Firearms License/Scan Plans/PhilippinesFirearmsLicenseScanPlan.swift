//
//  PhilippinesFirearmsLicenseScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesFirearmsLicenseScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesFirearmsLicenseScanPhase(name: "Philippines Firearms License")
        ])
    }
