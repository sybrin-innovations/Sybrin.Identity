...
final class PhilippinesIdentificationCardScanPlan: ScanPlan<DocumentModel> {
    ...
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            ...
            PhilippineIdentificationCardBackScanPhase(name: "Philippines Identification Card Back"),
            PhilippinesIdentificationCardNetworkPhase(name: "Confirm")
        ])
    }
