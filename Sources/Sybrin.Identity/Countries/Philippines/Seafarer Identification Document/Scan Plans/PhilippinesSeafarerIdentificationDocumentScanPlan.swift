//
//  PhilippinesSeafarerIdentificationDocumentScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesSeafarerIdentificationDocumentScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesSeafarerIdentificationDocumentFrontScanPhase(name: "Philippines Seafarer Identification Document Front"),
            PhilippinesSeafarerIdentificationDocumentBackScanPhase(name: "Philippines Seafarer Identification Document Back")
        ])
    }
