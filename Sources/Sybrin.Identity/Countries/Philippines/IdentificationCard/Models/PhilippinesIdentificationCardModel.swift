...
//    private enum CodingKeys: String, CodingKey { case address, bloodType, commonReferenceNumber, idDateOfBirth, dateOfIssued, givenNames, lastName, maritalStatus, middleName, placeOfBirth, idSex
//    }
//    
