//
//  PhilippinesPassportScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesPassportScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesPassportScanPhase(name: "Philippines Passport"),
            PhilippinesPassportNetworkPhase(name: "Confirm")
        ])
    }
