//
//  PhilippinesPhilHealthInsuranceCardScanPlan.swift
//  Sybrin.iOS.Identity
//
...
final class PhilippinesPhilHealthInsuranceCardScanPlan: ScanPlan<DocumentModel> {
    
    // MARK: Overrided Properties
    final override var Phases: ScanPhaseList<DocumentModel> {
        return ScanPhaseList(phases: [
            PhilippinesPhilHealthInsuranceCardScanPhase(name: "Philippines Phil Health Insurance Card"),
            PhilippinesPhilHealthInsuranceCardNetworkPhase(name: "Confirm")
        ])
    }
