////
////  TanzaniaPassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
////import MLKit
//
//final class TanzaniaPassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = TanzaniaPassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? TanzaniaPassportModel else { return }
