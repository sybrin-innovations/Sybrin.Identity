...
////import MLKit
//
//struct TanzaniaPassportParser {
//    
//    // MARK: Private Properties
//    // Parser
//    private let Parser = TraditionalTD3Parser(issuingCountryCode: Country.Tanzania.passportCountryCode)
//    
//    // Resetting Model
...
//    mutating func Parse(from result: Text, success: @escaping (_ model: TanzaniaPassportModel) -> Void) {
...
//        }
//    
//        if Parser.Line1Parsed && Parser.Line2Parsed, let model = TD3ModelToTanzaniaPassportModel(Parser.Model) {
//            success(model)
//            Reset()
//        }
//        
...
//    }
//    
//    private func TD3ModelToTanzaniaPassportModel(_ td3Model: TD3Model) -> TanzaniaPassportModel? {
//        let model = TanzaniaPassportModel()
//        
