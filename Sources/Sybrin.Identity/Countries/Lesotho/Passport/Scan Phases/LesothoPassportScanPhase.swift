////
////  LesothoPassportScanPhase.swift
////  Sybrin.iOS.Identity
////
...
//////import MLKit
//
//final class LesothoPassportScanPhase: ScanPhase<DocumentModel> {
//    
//    // MARK: Private Properties
//    private final var Face: Face?
//    private final var LastFrame: CMSampleBuffer?
//    private final var Parser = LesothoPassportParser()
//    
//    // Notify User
...
//        switch result {
//            case .success(_):
//                guard let model = Model as? LesothoPassportModel else { return }
