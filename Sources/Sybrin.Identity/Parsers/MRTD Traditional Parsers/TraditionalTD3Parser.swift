...
class TraditionalTD3Parser {
    
    init(issuingCountryCode:String?){
    ...
    var Line1: String?
    var Line2: String?
    var Line1Regex: NSRegularExpression { get { return RegexConstants.TD3_MRZ_Line1 } }
    var Line2Regex: NSRegularExpression { get { return RegexConstants.TD3_MRZ_Line2 } }
    var issuingCountryCode:String?
    var Model: TD3Model = TD3Model()
    ...
    func ParseLine1(from line: String) {
        ...
        if let _ = issuingCountryCode {
            guard Model.IssuingCountryCode == self.issuingCountryCode else { "Validation Failed: Issuing Country Code".log(.ProtectedWarning); return }
        }
    ...
    func ParseLine2(from line: String) {
        ...
        Model.OptionalDataCheckDigit = (line.substring(with: 42..<43) == "<") ? 0 : Int(line.substring(with: 42..<43))
