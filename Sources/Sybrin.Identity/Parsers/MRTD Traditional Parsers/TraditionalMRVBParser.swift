...
class TraditionalMRVBParser {
    
    // MARK: Internal Properties
    var Line1: String?
    var Line2: String?
    var Line1Regex: NSRegularExpression { get { return RegexConstants.MRVB_MRZ_Line1 } }
    var Line2Regex: NSRegularExpression { get { return RegexConstants.MRVB_MRZ_Line2 } }
    var Model: MRVBModel = MRVBModel()
    ...
    func ParseLine2(from line: String) {
        ...
        Model.OptionalData = line.substring(with: 28..<36).trimmingCharacters(in: CharacterSet(charactersIn: "< "))
